                    ...
                    while (!responded && timeout_counter < timeout_limit) {
                        ...
                        if (key == 'y') {
                            ...
                            if (g_event_count < MAX_EVENTS) {
                                ...
                                g_events[g_event_count].hour = new_hour;
                                g_events[g_event_count].minute = new_minute;
                                g_events[g_event_count].duration = 5;
                                g_events[g_event_count].title = suggestions[0].description;
                                g_events[g_event_count].is_suggestion = 1;  // Mark as AI suggestion
                                g_events[g_event_count].category = 7;  // Proactive action
